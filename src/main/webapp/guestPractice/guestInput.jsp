...
<div class="container">
	<h2 class="text-center">방명록 글올리기</h2>
	  <form name="myform" method="post" action="${ctp}/guestPractice/GuestInputOk" class="was-validated">
    ...
    <div class="form-group text-center">
    	...
    	<button type="button" onclick="location.href='${ctp}/guestPractice/GuestList';" class="btn btn-danger">돌아가기</button>
    </div>
