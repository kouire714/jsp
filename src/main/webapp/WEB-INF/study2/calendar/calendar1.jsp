...
<div class="container">
  <div class="text-center">
    <button type="button" onclick="location.href='calendar1.st?yy=${yy-1}&mm=${mm}';" class="btn btn-secondary btn-sm" title="이전년도"><i class='fas fa-angle-double-left' style='font-size:20px'></i></button>
