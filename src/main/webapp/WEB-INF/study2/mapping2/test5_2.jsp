...
<div class="container">
	...
	<hr/>
	<div>
		<input type="button" value="test5.jsp" onclick="location.href='${ctp}/mapping/test5.re';" class="btn btn-success "/>
		<input type="button" value="test5_3.jsp" onclick="location.href='${ctp}/mapping/test5_3.re';" class="btn btn-primary "/>
	</div>
	<hr/>
	<pre>
