...
create table member (
	...
	content	text,	/* 회원소개 */
	userInfo char(3) default '공개',	/* 회원 정보 공개여부(공개/비공개)*/
	userDel	char(3) default 'No',	/* 회원 탈퇴신청여부("NO:현재 활동중, Ok:,탈퇴신청중) */
	point	int default 100,	/* 회원 누적포인트(가입포인트100점, 1회방문시 10포인트증가, 1일 최대 50포인트 허용, 물건구매시 100원딩 1포인트 증가 */
