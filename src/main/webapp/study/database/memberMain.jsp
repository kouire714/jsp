...
<div class="container">
	...
	<div class="row">
		...
		<div class="col"><a href="${ctp}/database/memberList" class="btn btn-success">전체조회</a></div>
		<div class="col"><a href="${ctp}/database/memberLogout" class="btn btn-success">로그아웃</a></div>
		<div class="col"></div>
	</div>
	<hr/>
	<div id="demo"></div>
