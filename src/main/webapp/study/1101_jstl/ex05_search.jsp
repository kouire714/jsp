  ...
  <script>
    ...
    function nameCheck() {
    	...
    	if(name.trim() == "") {
    		...
    		//myform.submit();
    		location.href = "${ctp}/j1101/Ex05_searchStartOk?flag=name&name="+name;
    	}
    }
    
    function genderCheck() {
    	let gender = myform.gender.value;
    	location.href = "${ctp}/j1101/Ex05_searchStartOk?flag=gender&gender="+gender;
    }
  </script>
</head>
<body>
...
<div class="container">
  ...
  <form name="myform" method="post" action="${ctp}/j1101/Ex05_searchStartOk?flag=all">
