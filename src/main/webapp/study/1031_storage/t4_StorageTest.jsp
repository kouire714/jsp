...
<div class="container">
	...
	<p>세션 카운트 : ${sCount}</p>
	<hr/>
	<p><a href="t4_ApplicationStart.jsp" class="btn btn-success">어플리케이션 카운트 초기화</a></p>
	<p><a href="t4_SessionStart.jsp" class="btn btn-primary">세션 카운트 초기화</a></p>
	<p><a href="t4_StorageTest.jsp" class="btn btn-primary">방문수증가</a></p>
</div>
<p><br/></p>
</body>
</html>